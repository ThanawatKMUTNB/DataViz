...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        __qlistwidgetitem = QListWidgetItem(self.filterItemListWidget)
        __qlistwidgetitem.setCheckState(Qt.Unchecked);
        __qlistwidgetitem.setFlags(Qt.ItemIsSelectable|Qt.ItemIsDragEnabled|Qt.ItemIsUserCheckable|Qt.ItemIsEnabled|Qt.ItemIsTristate);
        __qlistwidgetitem1 = QListWidgetItem(self.filterItemListWidget)
        __qlistwidgetitem1.setCheckState(Qt.Unchecked);
        __qlistwidgetitem2 = QListWidgetItem(self.filterItemListWidget)
        ...
        self.filterItemListWidget.setSelectionMode(QAbstractItemView.MultiSelection)
        ...
        self.menubar.setGeometry(QRect(0, 0, 443, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteButton.setText(QCoreApplication.translate("MainWindow", u"Delete from Filter", None))
